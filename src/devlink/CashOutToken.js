...
export function CashOutToken({ as: _Component = _Builtin.Block, profit = {} }) {
  return (
    <_Component className="cashoutwrapper" tag="div">
      <_Builtin.Block className="cashoutbutton" tag="div">
        ...
        />
        <_Builtin.Block className="cashoutmultiplytext" tag="div" {...profit}>
          {"+100.90"}
        </_Builtin.Block>
